...
public final class ActivityNoteAddUpdateBinding implements ViewBinding {
  ...
  private ActivityNoteAddUpdateBinding(@NonNull LinearLayout rootView, @NonNull Button btnSubmit,
      @NonNull EditText edtDesc, @NonNull EditText edtTitle) {
  ...
  public static ActivityNoteAddUpdateBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.edt_desc;
      EditText edtDesc = rootView.findViewById(id);
      if (edtDesc == null) {
        break missingId;
      }
      ...
      return new ActivityNoteAddUpdateBinding((LinearLayout) rootView, btnSubmit, edtDesc,
          edtTitle);
    }
